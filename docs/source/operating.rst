[finalproject-93bc] Operating Details
====================================
...
.. important::
   ...
   **not be valid if your [finalproject-93bc] container is NOT running**.

.. tip::
   You must have your [finalproject-93bc] container running before connecting to the Visualization and Airflow URLs.
...
.. important::
   https://github.com/Project122024/raspberrypi/blob/main/tml-airflow/logs/logs.txt
...
.. note::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Project122024/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=39007  \-\-env VIPERVIZPORT=52087  \-\-env GITUSERNAME='Project122024'  \-\-env DOCKERUSERNAME='tmltss'  \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:52087/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:52087/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   tmltss/finalproject-93bc-amd64 (https://hub.docker.com/r/tmltss/finalproject-93bc-amd64)
...
.. code-block::
   ...
   docker run -d -p 53737:53737 -p 32893:32893 -p 47525:47525 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=finalproject-93bc \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-finalproject-93bc \-\-env GITUSERNAME=Project122024  \-\-env GITREPOURL=https://github.com/Project122024/raspberrypi \-\-env SOLUTIONEXTERNALPORT=53737  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=32893  \-\-env SOLUTIONVIPERVIZPORT=47525 \-\-env DOCKERUSERNAME='tmltss' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=39007 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=52087 \-\-env MQTTUSERNAME='hivemq.webclient.1725974242180' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  tmltss/finalproject-93bc-amd64
...
.. list-table::
   ...
   * - \-\-env KAFKACLOUDPASSWORD
     - This is your API Secret from Confluent Cloud.
   * - tmltss/finalproject-93bc-amd64
...
[finalproject-93bc] Github Repo
---------------
This is the Github repo for all your solution code

.. important::
   https://github.com/Project122024/raspberrypi/tree/main/tml-airflow/dags/tml-solutions/finalproject-93bc
...
.. important::
   https://finalproject-93bc.readthedocs.io
...
.. important::
   solution_preprocessing_ai_mqtt_dag-finalproject-93bc
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=53737, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=37873, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=41181, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=42393, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=36359, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=33861, HPDEHOST=127.0.1.1, HPDEPORT=35977, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=46739

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-3006-finalproject-93bc,solution_preprocessing_ai_mqtt_dag-finalproject-93bc, python-preprocess-5314-finalproject-93bc,solution_preprocessing_ai_mqtt_dag-finalproject-93bc, python-ai-4531-finalproject-93bc,solution_preprocessing_ai_mqtt_dag-finalproject-93bc, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
