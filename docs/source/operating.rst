...
.. important::
   docker run -d \-\-net=host \-\-env AIRFLOWPORT=9000  -v <change to your local folder>:/dagslocalbackup:z  -v /var/run/docker.sock:/var/run/docker.sock:z  \-\-env GITREPOURL=https://github.com/Project122024/raspberrypi  \-\-env CHIP=amd64 \-\-env TSS=1 \-\-env SOLUTIONNAME=TSS  \-\-env EXTERNALPORT=43595  \-\-env VIPERVIZPORT=54689  \-\-env GITUSERNAME='Project122024'  \-\-env DOCKERUSERNAME='tmltss'  \-\-env MQTTUSERNAME='Project2024'  \-\-env KAFKACLOUDUSERNAME=''  \-\-env KAFKACLOUDPASSWORD='<Enter your API secret>'  \-\-env READTHEDOCS='<Enter your readthedocs token>'  \-\-env GITPASSWORD='<Enter personal access token>'  \-\-env DOCKERPASSWORD='<Enter your docker hub password>'  \-\-env MQTTPASSWORD='<Enter your mqtt password>'  maadsdocker/tml-solution-studio-with-airflow-amd64
...
.. important::
   http://localhost:54689/tml-cisco-network-privategpt-monitor.html?topic=cisco-network-preprocess,cisco-network-privategpt&offset=-1&groupid=&rollbackoffset=400&topictype=prediction&append=0&secure=1
...
.. important::
   http://localhost:54689/viperlogs.html?topic=viperlogs&append=0
...
.. important::
   docker run -d -p 52263:52263 -p 56479:56479 -p 36483:36483 -p 8883:8883 \-\-env TSS=0 \-\-env SOLUTIONNAME=finalproject-93bc \-\-env SOLUTIONDAG=solution_preprocessing_ai_mqtt_dag-finalproject-93bc \-\-env GITUSERNAME=Project122024  \-\-env GITREPOURL=https://github.com/Project122024/raspberrypi \-\-env SOLUTIONEXTERNALPORT=52263  \-\-env CHIP=amd64 \-\-env SOLUTIONAIRFLOWPORT=56479  \-\-env SOLUTIONVIPERVIZPORT=36483 \-\-env DOCKERUSERNAME='tmltss' \-\-env CLIENTPORT=8883  \-\-env EXTERNALPORT=43595 \-\-env KAFKACLOUDUSERNAME=''  \-\-env VIPERVIZPORT=54689 \-\-env MQTTUSERNAME='Project2024' \-\-env AIRFLOWPORT=9000  \-\-env GITPASSWORD='<Enter Github Password>'  \-\-env KAFKACLOUDPASSWORD='<Enter API secret>'  \-\-env MQTTPASSWORD='<Enter mqtt password>'  \-\-env READTHEDOCS='<Enter Readthedocs token>'  tmltss/finalproject-93bc-amd64
...
.. important::
   VIPERHOST_PRODUCE=127.0.1.1, VIPERPORT_PRODUCE=52263, VIPERHOST_PREPOCESS=127.0.1.1, VIPERPORT_PREPROCESS=45315, VIPERHOST_PREPOCESS2=127.0.1.1, VIPERPORT_PREPROCESS2=36277, VIPERHOST_PREPOCESS_PGPT=127.0.1.1, VIPERPORT_PREPROCESS_PGPT=41079, VIPERHOST_ML=127.0.1.1, VIPERPORT_ML=44747, VIPERHOST_PREDCT=127.0.1.1, VIPERPORT_PREDICT=41333, HPDEHOST=127.0.1.1, HPDEPORT=33691, HPDEHOST_PREDICT=127.0.1.1, HPDEPORT_PREDICT=40521

Your Solution TMUX Windows 
-----------------------

.. important::
   python-produce-7548-finalproject-93bc,solution_preprocessing_ai_mqtt_dag-finalproject-93bc, python-preprocess-8411-finalproject-93bc,solution_preprocessing_ai_mqtt_dag-finalproject-93bc, python-ai-3133-finalproject-93bc,solution_preprocessing_ai_mqtt_dag-finalproject-93bc, viper-produce, viper-preprocess, viper-preprocess-pgpt, viper-ml, viper-predict
